<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../../images/useruploaded/images/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../images/useruploaded/images/'; // absolute or relative from this script path, required.
