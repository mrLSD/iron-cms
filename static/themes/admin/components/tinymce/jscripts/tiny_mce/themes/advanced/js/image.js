var ImageDialog = {
	...
	init : function() {
		...
		if (e.nodeName == 'IMG') {
			...
			f.vtspace.value = this.getAttrib(e, 'vtspace');
			f.vbspace.value = this.getAttrib(e, 'vbspace');
			f.hlspace.value = this.getAttrib(e, 'hlspace');
			f.hrspace.value = this.getAttrib(e, 'hrspace');
