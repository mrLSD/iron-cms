		...
		setupIframe : function() {
			...
			t.formatter.register({
				alignleft : [
					...
					{selector : 'img,table', collapsed : false, styles : {'float' : 'left', marginRight:'25px', marginBottom: '30px'}}
				],
				...
				alignright : [
					...
					{selector : 'img,table', collapsed : false, styles : {'float' : 'right', marginLeft:'25px', marginBottom: '30px'}}
				],
